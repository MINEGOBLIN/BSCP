...
8. Use the [fieldName_exfiltration.py](/blob/main/NoSQLi/Resources/resources/fieldName_exfiltration.py) script to extract the field name
...
11. Use the [fieldNameValue_exfiltration.py](/blob/main/NoSQLi/Resources/resources/fieldNameValue_exfiltration.py) script to extract the value of the `resetPwdToken`
	1. Change the `url` variable to match your lab
